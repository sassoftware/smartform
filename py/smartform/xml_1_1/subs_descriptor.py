...
class dataFieldTypeSub(supermod.dataFieldType):
    def __init__(self, name=None, descriptions=None, help=None, type_=None, section=None, enumeratedType=None, listType=None, descriptor=None, multiple=None, default=None, constraints=None, required=None, allowFileContent=None, hidden=None, password=None, readonly=None, multiline=None, conditional=None, prompt=None):
        supermod.dataFieldType.__init__(self, name, descriptions, help, type_, section, enumeratedType, listType, descriptor, multiple, default, constraints, required, allowFileContent, hidden, password, readonly, multiline, conditional, prompt)
...
class uniqueKeyTypeSub(supermod.uniqueKeyType):
    def __init__(self, valueOf_=''):
        supermod.uniqueKeyType.__init__(self, valueOf_)
supermod.uniqueKeyType.subclass = uniqueKeyTypeSub
# end class uniqueKeyTypeSub


class minLengthTypeSub(supermod.minLengthType):
    def __init__(self, valueOf_=''):
        supermod.minLengthType.__init__(self, valueOf_)
supermod.minLengthType.subclass = minLengthTypeSub
# end class minLengthTypeSub


class maxLengthTypeSub(supermod.maxLengthType):
    def __init__(self, valueOf_=''):
        supermod.maxLengthType.__init__(self, valueOf_)
supermod.maxLengthType.subclass = maxLengthTypeSub
# end class maxLengthTypeSub
