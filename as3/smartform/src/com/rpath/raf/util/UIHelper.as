    ...
    public class UIHelper
    {
        ...
        public static function checkBooleans(...args):Boolean
        {
            for each (var b:* in args)
            {
                ...
                {
                   if ((b as String).toLowerCase() == "false")
                       return false;
                }
            }
            return true;
        ...
        public static function formattedFileNameDate(date:Date=null):String
        {
            if (!date)
                date = new Date();
         ...
         * Replace \r\n and \n to \r
         */
        public static function transformToCarriageReturns(value:String):String
        {
            if (!value)
                return value;
            
            var nl:String = String.fromCharCode(10);
            var nlRegex:RegExp = new RegExp(nl, "gm");
            
            var crnl:String = String.fromCharCode(13, 10);
            var crnlRegex:RegExp = new RegExp(crnl, "gm");
            
            // process CRNL first
            value = value.replace(crnlRegex, '\r');
            
            // process CR
            value = value.replace(nlRegex, '\r');
            
            // process the plain string \n
            value = value.replace(/\\n/gm, '\r');
            
            // process the plain string \r
        ...
        public static function boolValue(val:Object):Boolean
        {
            var valString:String = val as String;
            var lowerVal:String;
            var result:Boolean;
            ...
            lowerVal = valString.toLowerCase();

            if (lowerVal == "true" || lowerVal == "t" || lowerVal == "1")
            {
                result = true;
            }
            else if (lowerVal == "false" || lowerVal == "f" || lowerVal == "0" || lowerVal == "")
            {
                result = false;
            }
